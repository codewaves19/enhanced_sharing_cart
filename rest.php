...
try {
	...
	switch (required_param('action', PARAM_TEXT)) {
        case 'render_tree': // public function in controller
        ...
        case 'is_userdata_copyable':
            ...
            exit;
        case 'is_userdata_copyable_section': // Checking user data is copyable or not
	...
	throw new enhanced_sharing_cart\exception('invalidoperation');
