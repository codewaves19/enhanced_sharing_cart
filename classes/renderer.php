...
/**
 *  Enhanced Sharing Cart item tree renderer
 */
class renderer
{
	/**
	...
	private static function render_dir_open($path, $leaf)
	{
        ...
        {
            $coursename = ' [' . get_string("variouscourse", "block_enhanced_sharing_cart") . ']';
        }
	...
	private static function render_item($path, $item)
	{
		...
		return '
				<li class="activity ' . $class . '" id="block_enhanced_sharing_cart-item-' . $item->id . '">
