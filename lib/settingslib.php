 ...
 */
class admin_setting_configmulticheckboxwithicon_en extends admin_setting_configmulticheckbox {
 ...
 */
class admin_setting_configmulticheckboxmodtypes_en extends admin_setting_configmulticheckboxwithicon_en {
    /**
 ...
 */
class admin_setting_configmulticheckboxqtypes_en extends admin_setting_configmulticheckboxwithicon_en {
    /**
     * @global core_renderer $OUTPUT
     * @param string $name
     * @param string $visiblename
