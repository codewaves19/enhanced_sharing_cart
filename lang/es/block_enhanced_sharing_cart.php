...
$string['enhanced_sharing_cart'] = 'Bolsa de recursos';
$string['enhanced_sharing_cart_help'] = '<h2 class="helpheading">Operación</h2>
...
$string['enhanced_sharing_cart:addinstance'] = 'Añadir un nuevo bloque bolsa de recursos';
