...
$string['enhanced_sharing_cart'] = '共有カート';
$string['enhanced_sharing_cart_help'] = '<h2 class="helpheading">操作方法</h2>
...
$string['enhanced_sharing_cart:addinstance'] = '新しい共有カートブロックを追加する';
