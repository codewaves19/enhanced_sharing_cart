...
class block_enhanced_sharing_cart extends block_base
{
	...
	public function get_content()
	{
        ...
        $html .= '<div class="modal-bg" style="display: none;" id="enhanced_sharing-cart-spinner-modal"><div class="spinner-container"><div style="margin-top: 10px;">' . get_string('inprogess_pleasewait', 'block_enhanced_sharing_cart') . '</div></div></div>';
		
		$this->page->requires->css('/blocks/enhanced_sharing_cart/styles.css');
		if ($this->is_special_version()) {
			$this->page->requires->css('/blocks/enhanced_sharing_cart/custom.css');
		}
//		$this->page->requires->js('/blocks/enhanced_sharing_cart/module.js');
//		$this->page->requires->yui_module('block_enhanced_sharing_cart', 'M.block_enhanced_sharing_cart.init', array(), null, true);
        $this->page->requires->jquery();
		$this->page->requires->js('/blocks/enhanced_sharing_cart/script.js');
	...
	private function get_header()
	{
		...
		$url = new moodle_url('/blocks/enhanced_sharing_cart/bulkdelete.php', array('course' => $this->page->course->id));
	...
	{
		global $OUTPUT;
		$helpicon = $OUTPUT->help_icon('enhanced_sharing_cart', __CLASS__);
